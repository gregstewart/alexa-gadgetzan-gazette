...
describe('test integration', () => {
  ...
  it('returns the expected response when content is found', (done) => {
    const expected = { utterance: `<speak><p>Welcome to the Blizzard News Flash!</p><p>Here is the news from Icy Veins.</p><p>In World of Warcraft news: Patch 7.1.5 Build 23244: Class Changes</p><p>Class changes related to the latest build of Patch 7.1.5.</p><p>In Diablo III news: Facebook Live Q/A: Dec 15</p><p>Diablo\'s getting a Q/A on Facebook Live today. Joe Senior Game Designer Joe Shely will be answering your questions.</p><p>In World of Warcraft news: Patch 7.1.5 Build 23244: Legendary Item Changes</p><p>Following the announcement of future changes to legendaries on PTR, Build 23244 has arrived and many legendary items have been nerfed.</p><p>In Heroes of the Storm news: Ragnaros Build Guide</p><p>Our guide section has been updated to include Ragnaros, the Firelord!</p><p>This concludes our news roundup.</p></speak>`, shouldSessionEnd: true};
